...
void ExpressionTypeComputation::visit(std::shared_ptr<AST> t) {
    if ( t->isNil() ) {
        ...
        switch ( t->getNodeType() ) {
            ...
            case vcalc::VCalcParser::GREATERTHAN:
            case vcalc::VCalcParser::LESSTHAN:
            case vcalc::VCalcParser::ISEQUAL:
            case vcalc::VCalcParser::ISNOTEQUAL:
                visitBinaryOperationToken(t);
                break;
            case vcalc::VCalcParser::RANGE:
                visitRANGE(t);
                break;
            case vcalc::VCalcParser::INDEX_TOKEN:
                visitINDEX_TOKEN(t);
                break;
            case vcalc::VCalcParser::PARENTHESIS_TOKEN:
                visitPARENTHESIS_TOKEN(t);
                break;
            case vcalc::VCalcParser::INTEGER:
                visitINTEGER(t);
                break;
